...
export const translations = {
  zh_TW: {
    ...
    resourceLibrary: "檔案與資源",
    resourceLibraryDetail: "軟體安裝檔、範例程式碼與模型權重",
    installerFiles: "安裝檔",
  ...
  en_US: {
    ...
    resourceLibrary: "Files & Resources",
    resourceLibraryDetail: "Installers, sample code, and model weights",
  ...
  ja_JP: {
    ...
    resourceLibrary: "ファイルとリソース",
    resourceLibraryDetail: "インストーラー、サンプルコード、モデルの重み",
