...
export const translations = {
  zh_TW: {
    ...
    modelResourcesDetail: "選擇項目後會開啟 Windows 存檔視窗",
  ...
  en_US: {
    ...
    modelResourcesDetail: "Choose an item to open the Windows save dialog",
  ...
  ja_JP: {
    ...
    modelResourcesDetail: "項目を選ぶと Windows の保存画面を開きます",
